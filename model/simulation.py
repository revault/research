...
class Simulation(object):
    ...
    def refill_amount(self, block_height, expected_new_vaults):
        ...
        # how many coins will be consolidated. We arbitrarily assume 1% of thecoins will (FIXME)
        consolidated_coins_count = int(self.wt.coin_pool.n_coins() // 100)
